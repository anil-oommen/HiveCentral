...
@EnableScheduling
@Deprecated
public class DataWarehouseTransfer {
    ...
    private static final org.slf4j.Logger logger = LoggerFactory.getLogger(DataWarehouseTransfer.class);
    ...
    public void runDataMove() {
        ...
        if(mongo!=null){
            ...
            MongoCollection<Document> colBots = mdW.getCollection("hiveBot");
