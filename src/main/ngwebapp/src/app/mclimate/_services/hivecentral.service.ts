...
import {AppSessionUser,HiveBotData,HiveBotInstruction,InstructionJobSchedule,HiveBotFunctionsData,SensorData,GenericMessage} from '../_models';
...
@Injectable()
export class HiveCentralService implements OnInit{
