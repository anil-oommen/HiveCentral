...
@Component({
  selector: 'app-mclimate-chart',
  templateUrl: './mclimate-chart.component.html',
  styleUrls: ['./mclimate-chart.component.css']
})
export class MclimateChartComponent implements OnInit {
